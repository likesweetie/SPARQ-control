...
interface EmbindModule {
  ...
  mjtEnableBit: {mjENBL_OVERRIDE: mjtEnableBitValue<1>, mjENBL_ENERGY: mjtEnableBitValue<2>, mjENBL_FWDINV: mjtEnableBitValue<4>, mjENBL_INVDISCRETE: mjtEnableBitValue<8>, mjENBL_SLEEP: mjtEnableBitValue<16>, mjNENABLE: mjtEnableBitValue<5>};
